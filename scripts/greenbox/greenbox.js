...
var parseIOTM = function(iotmParts) {
  return {
...
function loadIotms() {
  ...
  if (iotmCount === lastKnownSize)
    return null;
  return {
    data: iotms_default.map(function(i) {
      return parseIOTM([i.id, i.mmyyyy]);
    }),
    size: iotmCount
  };
}
var compressIotms = function(iotmList2) {
  return iotmList2.sort(function(a, b) {
    return a[0] - b[0];
...
function recordFamiliarIOTM(fam) {
  return {
    storeItem: fam.hatchling,
    boundItem: fam,
    have: (0, import_kolmafia4.haveFamiliar)(fam),
    count: (0, import_kolmafia4.availableAmount)(fam.hatchling)
  };
}
function recordItemIOTM(item) {
  var boundItem = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : $item(_templateObject || (_templateObject = _taggedTemplateLiteral2(["cob of corn"])));
  if (boundItem === $item(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral2(["cob of corn"])))) {
    return {
      storeItem: item,
      have: (0, import_kolmafia4.availableAmount)(item) > 0,
      count: (0, import_kolmafia4.availableAmount)(item)
    };
  } else {
    return {
      storeItem: item,
      boundItem: boundItem,
      have: (0, import_kolmafia4.availableAmount)(boundItem) > 0,
      count: (0, import_kolmafia4.availableAmount)(item)
    };
  }
}
function recordSkillIOTM(skill, skillBook) {
  return {
    storeItem: skillBook,
    have: have(skill),
    count: (0, import_kolmafia4.availableAmount)(skillBook)
  };
}
function recordFoldableIOTM(foldable) {
  var allFolds = getFoldGroup(foldable);
  return {
    storeItem: foldable,
    itemOptions: allFolds,
    have: allFolds.some(function(item) {
      return have(item);
    }),
    count: sum(allFolds, function(item) {
      return (0, import_kolmafia4.availableAmount)(item);
    })
  };
}
function recordVIPIOTM(vipItem) {
  return {
    storeItem: vipItem,
    have: have($item(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral2(["Clan VIP Lounge Key"])))),
    count: (0, import_kolmafia4.availableAmount)(vipItem)
  };
}
function recordGardenIOTM(catalog, seeds) {
  return {
    storeItem: catalog,
    boundItem: seeds,
    have: have(seeds) || haveInCampground(seeds),
    count: (0, import_kolmafia4.availableAmount)(catalog)
  };
}
function recordEudoraIOTM(eudora) {
  var eudoraNumber = 1 + eudorae.indexOf(eudora.name);
  var eudoraList = (0, import_kolmafia4.xpath)((0, import_kolmafia4.visitUrl)("account.php?tab=correspondence"), '//select[@name="whichpenpal"]/option/@value');
  var haveEudora;
  if (eudoraNumber == 0)
    haveEudora = false;
  else
    haveEudora = eudoraList.includes(eudoraNumber.toFixed(0));
  return {
    storeItem: eudora,
    have: haveEudora,
    count: (0, import_kolmafia4.availableAmount)(eudora)
  };
}
function recordWorkshedIOTM(voucher, workshedItem) {
  var _workshedItem;
  (_workshedItem = workshedItem) !== null && _workshedItem !== void 0 ? _workshedItem : workshedItem = voucher;
  return {
    storeItem: voucher,
    boundItem: workshedItem,
    have: have(voucher) || have(workshedItem) || haveInCampground(workshedItem),
    count: (0, import_kolmafia4.availableAmount)(voucher)
  };
}
function recordPreferenceIOTM(accessUnlocker, mafiaPref) {
  return {
    storeItem: accessUnlocker,
    have: get(mafiaPref),
    count: (0, import_kolmafia4.availableAmount)(accessUnlocker)
  };
}
var iotmList = [
  recordFamiliarIOTM($familiar(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral2(["Jill-O-Lantern"])))),
  recordFamiliarIOTM($familiar(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral2(["Jill-O-Lantern"])))),
  recordFamiliarIOTM($familiar(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral2(["Hand Turkey"])))),
  recordFamiliarIOTM($familiar(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral2(["Crimbo Elf"])))),
  recordFamiliarIOTM($familiar(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral2(["Baby Yeti"])))),
  recordFamiliarIOTM($familiar(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral2(["Feather Boa Constrictor"])))),
  recordItemIOTM($item(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral2(["lucky Tam O'Shanter"])))),
  recordFamiliarIOTM($familiar(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral2(["Personal Raincloud"])))),
  recordItemIOTM($item(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral2(["miniature gravy-covered maypole"])))),
  recordFamiliarIOTM($familiar(_templateObject132 || (_templateObject132 = _taggedTemplateLiteral2(["Inflatable Dodecapede"])))),
  recordItemIOTM($item(_templateObject142 || (_templateObject142 = _taggedTemplateLiteral2(["wax lips"])))),
  recordFamiliarIOTM($familiar(_templateObject152 || (_templateObject152 = _taggedTemplateLiteral2(["Pygmy Bugbear Shaman"])))),
  recordItemIOTM($item(_templateObject162 || (_templateObject162 = _taggedTemplateLiteral2(["Jekyllin hide belt"])))),
  recordFamiliarIOTM($familiar(_templateObject172 || (_templateObject172 = _taggedTemplateLiteral2(["Doppelshifter"])))),
  recordFamiliarIOTM($familiar(_templateObject182 || (_templateObject182 = _taggedTemplateLiteral2(["Temporal Riftlet"])))),
  recordFamiliarIOTM($familiar(_templateObject192 || (_templateObject192 = _taggedTemplateLiteral2(["Sweet Nutcracker"])))),
  recordSkillIOTM($skill(_templateObject202 || (_templateObject202 = _taggedTemplateLiteral2(["Summon Snowcones"]))), $item(_templateObject212 || (_templateObject212 = _taggedTemplateLiteral2(["Tome of Snowcone Summoning"])))),
  recordFoldableIOTM($item(_templateObject222 || (_templateObject222 = _taggedTemplateLiteral2(["iceberglet"])))),
  recordFamiliarIOTM($familiar(_templateObject232 || (_templateObject232 = _taggedTemplateLiteral2(["Wild Hare"])))),
  recordSkillIOTM($skill(_templateObject242 || (_templateObject242 = _taggedTemplateLiteral2(["Summon Hilarious Objects"]))), $item(_templateObject252 || (_templateObject252 = _taggedTemplateLiteral2(["McPhee's Grimoire of Hilarious Object Summoning"])))),
  recordFamiliarIOTM($familiar(_templateObject262 || (_templateObject262 = _taggedTemplateLiteral2(["Spirit Hobo"])))),
  recordFamiliarIOTM($familiar(_templateObject272 || (_templateObject272 = _taggedTemplateLiteral2(["Astral Badger"])))),
  recordItemIOTM($item(_templateObject282 || (_templateObject282 = _taggedTemplateLiteral2(["jewel-eyed wizard hat"])))),
  recordFamiliarIOTM($familiar(_templateObject292 || (_templateObject292 = _taggedTemplateLiteral2(["Comma Chameleon"])))),
  recordItemIOTM($item(_templateObject302 || (_templateObject302 = _taggedTemplateLiteral2(["Travoltan trousers"])))),
  recordItemIOTM($item(_templateObject312 || (_templateObject312 = _taggedTemplateLiteral2(["plastic pumpkin bucket"])))),
  recordItemIOTM($item(_templateObject322 || (_templateObject322 = _taggedTemplateLiteral2(["pilgrim shield"])))),
  recordFamiliarIOTM($familiar(_templateObject332 || (_templateObject332 = _taggedTemplateLiteral2(["Ancient Yuletide Troll"])))),
  recordFoldableIOTM($item(_templateObject342 || (_templateObject342 = _taggedTemplateLiteral2(["Great Ball of Frozen Fire"])))),
  recordSkillIOTM($skill(_templateObject352 || (_templateObject352 = _taggedTemplateLiteral2(["Summon Candy Heart"]))), $item(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral2(["Libram of Candy Heart Summoning"])))),
  recordFamiliarIOTM($familiar(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral2(["Dandy Lion"])))),
  recordFamiliarIOTM($familiar(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral2(["Penguin Goodfella"])))),
  recordItemIOTM($item(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral2(["Mayflower bouquet"])))),
  recordFamiliarIOTM($familiar(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral2(["Green Pixie"])))),
  recordItemIOTM($item(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral2(["bottle-rocket crossbow"])))),
  recordFamiliarIOTM($familiar(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral2(["Wizard Action Figure"])))),
  recordItemIOTM($item(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral2(["navel ring of navel gazing"])))),
  recordFamiliarIOTM($familiar(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral2(["Gluttonous Green Ghost"])))),
  recordItemIOTM($item(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral2(["V for Vivala mask"])))),
  recordFamiliarIOTM($familiar(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral2(["Crimbo P. R. E. S. S. I. E."])))),
  recordSkillIOTM($skill(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral2(["Summon Party Favor"]))), $item(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral2(["Libram of Divine Favors"])))),
  recordFoldableIOTM($item(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral2(["naughty origami kit"])))),
  recordFamiliarIOTM($familiar(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral2(["Mad Hatrack"])))),
  recordSkillIOTM($skill(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral2(["Summon Tasteful Items"]))), $item(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral2(["Sp'n-Zor's Grimoire of \"Tasteful\" Gifts"])))),
  recordItemIOTM($item(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral2(["packet of mayfly bait"]))), $item(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral2(["mayfly bait necklace"])))),
  recordFamiliarIOTM($familiar(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral2(["Llama Lama"])))),
  recordItemIOTM($item(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral2(["little box of fireworks"])))),
  recordFamiliarIOTM($familiar(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral2(["Cotton Candy Carnie"])))),
  recordItemIOTM($item(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral2(["haiku katana"])))),
  recordFamiliarIOTM($familiar(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral2(["Disembodied Hand"])))),
  recordSkillIOTM($skill(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral2(["Summon Stickers"]))), $item(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral2(["Scratch 'n' Sniff Sticker Tome"])))),
  recordFamiliarIOTM($familiar(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral2(["Sugar Fruit Fairy"])))),
  {
    storeItem: $item(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral2(["container of Spooky Putty"]))),
    itemOptions: getFoldGroup($item(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral2(["container of Spooky Putty"])))),
    have: getFoldGroup($item(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral2(["container of Spooky Putty"])))).some(function(item) {
      return have(item);
    }) || (0, import_kolmafia4.availableAmount)($item(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral2(["spooky putty monster"])))) > 1,
    count: sum(getFoldGroup($item(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral2(["container of Spooky Putty"])))), function(item) {
      return (0, import_kolmafia4.availableAmount)(item);
    })
  },
  recordSkillIOTM($skill(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral2(["Summon Love Song"]))), $item(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral2(["Libram of Love Songs"])))),
  recordFamiliarIOTM($familiar(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral2(["Frumious Bandersnatch"])))),
  recordItemIOTM($item(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral2(["elvish sunglasses"])))),
  recordVIPIOTM($item(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral2(["Clan pool table"])))),
  recordFamiliarIOTM($familiar(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral2(["Baby Sandworm"])))),
  recordItemIOTM($item(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral2(["Bag o' Tricks"])))),
  recordFamiliarIOTM($familiar(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral2(["He-Boulder"])))),
  recordSkillIOTM($skill(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral2(["Summon Sugar Sheets"]))), $item(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral2(["Tome of Sugar Shummoning"])))),
  recordFamiliarIOTM($familiar(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral2(["Squamous Gibberer"])))),
  recordItemIOTM($item(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral2(["moveable feast"])))),
  recordFamiliarIOTM($familiar(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral2(["Stocking Mimic"])))),
  recordFoldableIOTM($item(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral2(["stinky cheese ball"])))),
  recordSkillIOTM($skill(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral2(["Summon BRICKOs"]))), $item(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral2(["Libram of BRICKOs"])))),
  recordVIPIOTM($item(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral2(["Clan looking glass"])))),
  recordFamiliarIOTM($familiar(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral2(["Baby Bugged Bugbear"])))),
  recordItemIOTM($item(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral2(["Crown of Thrones"])))),
  recordFamiliarIOTM($familiar(_templateObject87 || (_templateObject87 = _taggedTemplateLiteral2(["Rogue Program"])))),
  recordItemIOTM($item(_templateObject88 || (_templateObject88 = _taggedTemplateLiteral2(["Juju Mojo Mask"])))),
  recordFamiliarIOTM($familiar(_templateObject89 || (_templateObject89 = _taggedTemplateLiteral2(["Mini-Hipster"])))),
  recordItemIOTM($item(_templateObject90 || (_templateObject90 = _taggedTemplateLiteral2(["Greatest American Pants"])))),
  recordFamiliarIOTM($familiar(_templateObject91 || (_templateObject91 = _taggedTemplateLiteral2(["Knob Goblin Organ Grinder"])))),
  recordGardenIOTM($item(_templateObject92 || (_templateObject92 = _taggedTemplateLiteral2(["Grumpy Bumpkin's Pumpkin Seed Catalog"]))), $item(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral2(["packet of pumpkin seeds"])))),
  recordFamiliarIOTM($familiar(_templateObject94 || (_templateObject94 = _taggedTemplateLiteral2(["Robot Reindeer"])))),
  recordFoldableIOTM($item(_templateObject95 || (_templateObject95 = _taggedTemplateLiteral2(["Loathing Legion Knife"])))),
  recordFamiliarIOTM($familiar(_templateObject96 || (_templateObject96 = _taggedTemplateLiteral2(["Obtuse Angel"])))),
  recordSkillIOTM($skill(_templateObject97 || (_templateObject97 = _taggedTemplateLiteral2(["Summon Alice's Army Cards"]))), $item(_templateObject98 || (_templateObject98 = _taggedTemplateLiteral2(["Sorcerers of the Shore Grimoire"])))),
  recordVIPIOTM($item(_templateObject99 || (_templateObject99 = _taggedTemplateLiteral2(["Clan shower"])))),
  recordEudoraIOTM($item(_templateObject100 || (_templateObject100 = _taggedTemplateLiteral2(["My Own Pen Pal kit"])))),
  recordFamiliarIOTM($familiar(_templateObject101 || (_templateObject101 = _taggedTemplateLiteral2(["Li'l Xenomorph"])))),
  recordItemIOTM($item(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral2(["Operation Patriot Shield"])))),
  recordFamiliarIOTM($familiar(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral2(["Pair of Stomping Boots"])))),
  recordSkillIOTM($skill(_templateObject104 || (_templateObject104 = _taggedTemplateLiteral2(["Summon Clip Art"]))), $item(_templateObject105 || (_templateObject105 = _taggedTemplateLiteral2(["Tome of Clip Art"])))),
  recordItemIOTM($item(_templateObject106 || (_templateObject106 = _taggedTemplateLiteral2(["Make-Your-Own-Vampire-Fangs kit"]))), $item(_templateObject107 || (_templateObject107 = _taggedTemplateLiteral2(["plastic vampire fangs"])))),
  recordFamiliarIOTM($familiar(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral2(["Fancypants Scarecrow"])))),
  recordGardenIOTM($item(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral2(["Mint Salton Pepper's Peppermint Seed Catalog"]))), $item(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral2(["Peppermint Pip Packet"])))),
  recordSkillIOTM($skill(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral2(["Summon Resolutions"]))), $item(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral2(["Libram of Resolutions"])))),
  recordFoldableIOTM($item(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral2(["can of Rain-Doh"])))),
  recordFamiliarIOTM($familiar(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral2(["Happy Medium"])))),
  recordFoldableIOTM($item(_templateObject115 || (_templateObject115 = _taggedTemplateLiteral2(["Boris's Helm"])))),
  recordVIPIOTM($item(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral2(["Olympic-sized Clan crate"])))),
  recordFamiliarIOTM($familiar(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral2(["Artistic Goth Kid"])))),
  recordItemIOTM($item(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral2(["Camp Scout backpack"])))),
  recordFamiliarIOTM($familiar(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral2(["Reagnimated Gnome"])))),
  {
    storeItem: $item(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral2(["box of bear arms"]))),
    have: have($item(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral2(["box of bear arms"])))) || have($item(_templateObject122 || (_templateObject122 = _taggedTemplateLiteral2(["right bear arm"])))) && have($item(_templateObject123 || (_templateObject123 = _taggedTemplateLiteral2(["left bear arm"])))),
    count: sum($items(_templateObject124 || (_templateObject124 = _taggedTemplateLiteral2(["box of bear arms, right bear arm, left bear arm"]))), import_kolmafia4.availableAmount)
  },
  recordGardenIOTM($item(_templateObject125 || (_templateObject125 = _taggedTemplateLiteral2(["Pete & Jackie's Dragon Tooth Emporium Catalog"]))), $item(_templateObject126 || (_templateObject126 = _taggedTemplateLiteral2(["packet of dragon's teeth"])))),
  recordFamiliarIOTM($familiar(_templateObject127 || (_templateObject127 = _taggedTemplateLiteral2(["Nanorhino"])))),
  recordSkillIOTM($skill(_templateObject128 || (_templateObject128 = _taggedTemplateLiteral2(["Summon Geeky Gifts"]))), $item(_templateObject129 || (_templateObject129 = _taggedTemplateLiteral2(["Thinknerd's Grimoire of Geeky Gifts"])))),
  recordItemIOTM($item(_templateObject130 || (_templateObject130 = _taggedTemplateLiteral2(["Snow Suit"])))),
  recordEudoraIOTM($item(_templateObject131 || (_templateObject131 = _taggedTemplateLiteral2(["GameInformPowerDailyPro subscription card"])))),
  recordFoldableIOTM($item(_templateObject1322 || (_templateObject1322 = _taggedTemplateLiteral2(["Jarlsberg's Pan"])))),
  recordSkillIOTM($skill(_templateObject133 || (_templateObject133 = _taggedTemplateLiteral2(["Summon Taffy"]))), $item(_templateObject134 || (_templateObject134 = _taggedTemplateLiteral2(["Libram of Pulled Taffy"])))),
  {
    storeItem: $item(_templateObject135 || (_templateObject135 = _taggedTemplateLiteral2(["Order of the Green Thumb Order Form"]))),
    have: (0, import_kolmafia4.floristAvailable)(),
    count: (0, import_kolmafia4.availableAmount)($item(_templateObject136 || (_templateObject136 = _taggedTemplateLiteral2(["Order of the Green Thumb Order Form"]))))
  },
  recordFamiliarIOTM($familiar(_templateObject137 || (_templateObject137 = _taggedTemplateLiteral2(["Mini-Adventurer"])))),
  recordVIPIOTM($item(_templateObject138 || (_templateObject138 = _taggedTemplateLiteral2(["Clan hot dog stand"])))),
  recordItemIOTM($item(_templateObject139 || (_templateObject139 = _taggedTemplateLiteral2(["Folder Holder"]))), $item(_templateObject140 || (_templateObject140 = _taggedTemplateLiteral2(["over-the-shoulder Folder Holder"])))),
  recordFamiliarIOTM($familiar(_templateObject141 || (_templateObject141 = _taggedTemplateLiteral2(["Steam-Powered Cheerleader"])))),
  recordFamiliarIOTM($familiar(_templateObject1422 || (_templateObject1422 = _taggedTemplateLiteral2(["Reanimated Reanimator"])))),
  recordItemIOTM($item(_templateObject143 || (_templateObject143 = _taggedTemplateLiteral2(["Pantsgiving"])))),
  recordSkillIOTM($skill(_templateObject144 || (_templateObject144 = _taggedTemplateLiteral2(["Summon Smithsness"]))), $item(_templateObject145 || (_templateObject145 = _taggedTemplateLiteral2(["The Smith's Tome"])))),
  recordGardenIOTM($item(_templateObject146 || (_templateObject146 = _taggedTemplateLiteral2(["Discontent\u2122 Winter Garden Catalog"]))), $item(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral2(["packet of winter seeds"])))),
  recordItemIOTM($item(_templateObject148 || (_templateObject148 = _taggedTemplateLiteral2(["Buddy Bjorn"])))),
  recordFoldableIOTM($item(_templateObject149 || (_templateObject149 = _taggedTemplateLiteral2(["Sneaky Pete's leather jacket"])))),
  recordWorkshedIOTM($item(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral2(["Little Geneticist DNA-Splicing Lab"])))),
  recordPreferenceIOTM($item(_templateObject151 || (_templateObject151 = _taggedTemplateLiteral2(["airplane charter: Spring Break Beach"]))), "sleazeAirportAlways"),
  recordFamiliarIOTM($familiar(_templateObject1522 || (_templateObject1522 = _taggedTemplateLiteral2(["Galloping Grill"])))),
  recordVIPIOTM($item(_templateObject153 || (_templateObject153 = _taggedTemplateLiteral2(["Clan speakeasy"])))),
  recordSkillIOTM($skill(_templateObject154 || (_templateObject154 = _taggedTemplateLiteral2(["Summon Confiscated Things"]))), $item(_templateObject155 || (_templateObject155 = _taggedTemplateLiteral2(["The Confiscator's Grimoire"])))),
  recordItemIOTM($item(_templateObject156 || (_templateObject156 = _taggedTemplateLiteral2(["Thor's Pliers"])))),
  recordPreferenceIOTM($item(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral2(["airplane charter: Conspiracy Island"]))), "spookyAirportAlways"),
  recordFamiliarIOTM($familiar(_templateObject158 || (_templateObject158 = _taggedTemplateLiteral2(["Fist Turkey"])))),
  recordFamiliarIOTM($familiar(_templateObject159 || (_templateObject159 = _taggedTemplateLiteral2(["Crimbo Shrub"])))),
  recordPreferenceIOTM($item(_templateObject160 || (_templateObject160 = _taggedTemplateLiteral2(["Chateau Mantegna room key"]))), "chateauAvailable"),
  recordPreferenceIOTM($item(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral2(["bottle of lovebug pheromones"]))), "lovebugsUnlocked"),
  recordItemIOTM($item(_templateObject1622 || (_templateObject1622 = _taggedTemplateLiteral2(["Ed the Undying Exhibit Crate"]))), $item(_templateObject163 || (_templateObject163 = _taggedTemplateLiteral2(["The Crown of Ed the Undying"])))),
  recordPreferenceIOTM($item(_templateObject164 || (_templateObject164 = _taggedTemplateLiteral2(["airplane charter: Dinseylandfill"]))), "stenchAirportAlways"),
  recordWorkshedIOTM($item(_templateObject165 || (_templateObject165 = _taggedTemplateLiteral2(["portable Mayo Clinic"])))),
  recordFamiliarIOTM($familiar(_templateObject166 || (_templateObject166 = _taggedTemplateLiteral2(["Puck Man"])))),
  recordItemIOTM($item(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral2(["Pack of Every Card"]))), $item(_templateObject168 || (_templateObject168 = _taggedTemplateLiteral2(["Deck of Every Card"])))),
  recordPreferenceIOTM($item(_templateObject169 || (_templateObject169 = _taggedTemplateLiteral2(["airplane charter: That 70s Volcano"]))), "hotAirportAlways"),
  recordPreferenceIOTM($item(_templateObject170 || (_templateObject170 = _taggedTemplateLiteral2(["shrine to the Barrel god"]))), "barrelShrineUnlocked"),
  recordWorkshedIOTM($item(_templateObject171 || (_templateObject171 = _taggedTemplateLiteral2(["haunted doghouse"])))),
  recordPreferenceIOTM($item(_templateObject1722 || (_templateObject1722 = _taggedTemplateLiteral2(["airplane charter: The Glaciest"]))), "coldAirportAlways"),
  recordFamiliarIOTM($familiar(_templateObject173 || (_templateObject173 = _taggedTemplateLiteral2(["Machine Elf"])))),
  recordPreferenceIOTM($item(_templateObject174 || (_templateObject174 = _taggedTemplateLiteral2(["X-32-F snowman crate"]))), "snojoAvailable"),
  recordPreferenceIOTM($item(_templateObject175 || (_templateObject175 = _taggedTemplateLiteral2(["LT&T telegraph office deed"]))), "telegraphOfficeAvailable"),
  recordWorkshedIOTM($item(_templateObject176 || (_templateObject176 = _taggedTemplateLiteral2(["Witchess Set"])))),
  recordVIPIOTM($item(_templateObject177 || (_templateObject177 = _taggedTemplateLiteral2(["Clan Floundry"])))),
  recordFamiliarIOTM($familiar(_templateObject178 || (_templateObject178 = _taggedTemplateLiteral2(["intergnat"])))),
  recordWorkshedIOTM($item(_templateObject179 || (_templateObject179 = _taggedTemplateLiteral2(["Source Terminal"])))),
  recordPreferenceIOTM($item(_templateObject180 || (_templateObject180 = _taggedTemplateLiteral2(["detective school application"]))), "hasDetectiveSchool"),
  recordItemIOTM($item(_templateObject181 || (_templateObject181 = _taggedTemplateLiteral2(["DIY protonic accelerator kit"]))), $item(_templateObject1822 || (_templateObject1822 = _taggedTemplateLiteral2(["protonic accelerator pack"])))),
  recordItemIOTM($item(_templateObject183 || (_templateObject183 = _taggedTemplateLiteral2(["Dear Past Self Package"]))), $item(_templateObject184 || (_templateObject184 = _taggedTemplateLiteral2(["Time-Spinner"])))),
  recordFamiliarIOTM($familiar(_templateObject185 || (_templateObject185 = _taggedTemplateLiteral2(["Trick-or-Treating Tot"])))),
  recordGardenIOTM($item(_templateObject186 || (_templateObject186 = _taggedTemplateLiteral2(["Granny Tood's Thanksgarden Catalog"]))), $item(_templateObject187 || (_templateObject187 = _taggedTemplateLiteral2(["packet of thanksgarden seeds"])))),
  recordPreferenceIOTM($item(_templateObject188 || (_templateObject188 = _taggedTemplateLiteral2(["Build-a-City Gingerbread kit"]))), "gingerbreadCityAvailable"),
  recordFamiliarIOTM($familiar(_templateObject189 || (_templateObject189 = _taggedTemplateLiteral2(["Space Jellyfish"])))),
  recordPreferenceIOTM($item(_templateObject190 || (_templateObject190 = _taggedTemplateLiteral2(["heart-shaped crate"]))), "loveTunnelAvailable"),
  recordFamiliarIOTM($familiar(_templateObject191 || (_templateObject191 = _taggedTemplateLiteral2(["Robortender"])))),
  recordPreferenceIOTM($item(_templateObject1922 || (_templateObject1922 = _taggedTemplateLiteral2(["Spacegate access badge"]))), "spacegateAlways"),
  recordEudoraIOTM($item(_templateObject193 || (_templateObject193 = _taggedTemplateLiteral2(["New-You Club Membership Form"])))),
  recordItemIOTM($item(_templateObject194 || (_templateObject194 = _taggedTemplateLiteral2(["suspicious package"]))), $item(_templateObject195 || (_templateObject195 = _taggedTemplateLiteral2(["Kremlin's Greatest Briefcase"])))),
  recordWorkshedIOTM($item(_templateObject196 || (_templateObject196 = _taggedTemplateLiteral2(["LI-11 Motor Pool voucher"]))), $item(_templateObject197 || (_templateObject197 = _taggedTemplateLiteral2(["Asdon Martin keyfob"])))),
  recordSkillIOTM($skill(_templateObject198 || (_templateObject198 = _taggedTemplateLiteral2(["Meteor Lore"]))), $item(_templateObject199 || (_templateObject199 = _taggedTemplateLiteral2(["Pocket Meteor Guide"])))),
  recordItemIOTM($item(_templateObject200 || (_templateObject200 = _taggedTemplateLiteral2(["corked genie bottle"]))), $item(_templateObject201 || (_templateObject201 = _taggedTemplateLiteral2(["genie bottle"])))),
  recordFamiliarIOTM($familiar(_templateObject2022 || (_templateObject2022 = _taggedTemplateLiteral2(["XO Skeleton"])))),
  recordItemIOTM($item(_templateObject203 || (_templateObject203 = _taggedTemplateLiteral2(["pantogram"]))), $item(_templateObject204 || (_templateObject204 = _taggedTemplateLiteral2(["portable pantogram"])))),
  recordItemIOTM($item(_templateObject205 || (_templateObject205 = _taggedTemplateLiteral2(["locked mumming trunk"]))), $item(_templateObject206 || (_templateObject206 = _taggedTemplateLiteral2(["mumming trunk"])))),
  recordItemIOTM($item(_templateObject207 || (_templateObject207 = _taggedTemplateLiteral2(["January's Garbage Tote (unopened)"]))), $item(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral2(["January's Garbage Tote"])))),
  recordVIPIOTM($item(_templateObject209 || (_templateObject209 = _taggedTemplateLiteral2(["Clan Carnival Game"])))),
  recordGardenIOTM($item(_templateObject210 || (_templateObject210 = _taggedTemplateLiteral2(["Pok\xE9fam Guide to Capturing All of Them"]))), $item(_templateObject211 || (_templateObject211 = _taggedTemplateLiteral2(["packet of tall grass seeds"])))),
  recordPreferenceIOTM($item(_templateObject2122 || (_templateObject2122 = _taggedTemplateLiteral2(["FantasyRealm membership packet"]))), "frAlways"),
  recordFamiliarIOTM($familiar(_templateObject213 || (_templateObject213 = _taggedTemplateLiteral2(["God Lobster"])))),
  recordItemIOTM($item(_templateObject214 || (_templateObject214 = _taggedTemplateLiteral2(["SongBoom\u2122 BoomBox Box"]))), $item(_templateObject215 || (_templateObject215 = _taggedTemplateLiteral2(["SongBoom\u2122 BoomBox"])))),
  recordFamiliarIOTM($familiar(_templateObject216 || (_templateObject216 = _taggedTemplateLiteral2(["Cat Burglar"])))),
  recordItemIOTM($item(_templateObject217 || (_templateObject217 = _taggedTemplateLiteral2(["Bastille Battalion control rig crate"]))), $item(_templateObject218 || (_templateObject218 = _taggedTemplateLiteral2(["Bastille Battalion control rig"])))),
  recordPreferenceIOTM($item(_templateObject219 || (_templateObject219 = _taggedTemplateLiteral2(["Neverending Party invitation envelope"]))), "neverendingPartyAlways"),
  recordItemIOTM($item(_templateObject220 || (_templateObject220 = _taggedTemplateLiteral2(["latte lovers club card"]))), $item(_templateObject221 || (_templateObject221 = _taggedTemplateLiteral2(["latte lovers member's mug"])))),
  recordPreferenceIOTM($item(_templateObject2222 || (_templateObject2222 = _taggedTemplateLiteral2(["voter registration form"]))), "voteAlways"),
  recordPreferenceIOTM($item(_templateObject223 || (_templateObject223 = _taggedTemplateLiteral2(["Boxing Day care package"]))), "daycareOpen"),
  recordItemIOTM($item(_templateObject224 || (_templateObject224 = _taggedTemplateLiteral2(["Kramco Industries packing carton"]))), $item(_templateObject225 || (_templateObject225 = _taggedTemplateLiteral2(["Kramco Sausage-o-Matic\u2122"])))),
  recordItemIOTM($item(_templateObject226 || (_templateObject226 = _taggedTemplateLiteral2(["mint condition Lil' Doctor\u2122 bag"]))), $item(_templateObject227 || (_templateObject227 = _taggedTemplateLiteral2(["Lil' Doctor\u2122 bag"])))),
  recordItemIOTM($item(_templateObject228 || (_templateObject228 = _taggedTemplateLiteral2(["vampyric cloake pattern"]))), $item(_templateObject229 || (_templateObject229 = _taggedTemplateLiteral2(["vampyric cloake"])))),
  recordPreferenceIOTM($item(_templateObject230 || (_templateObject230 = _taggedTemplateLiteral2(["PirateRealm membership packet"]))), "prAlways"),
  recordItemIOTM($item(_templateObject231 || (_templateObject231 = _taggedTemplateLiteral2(["Fourth of May Cosplay Saber kit"]))), $item(_templateObject2322 || (_templateObject2322 = _taggedTemplateLiteral2(["Fourth of May Cosplay Saber"])))),
  recordItemIOTM($item(_templateObject233 || (_templateObject233 = _taggedTemplateLiteral2(["rune-strewn spoon cocoon"]))), $item(_templateObject234 || (_templateObject234 = _taggedTemplateLiteral2(["hewn moon-rune spoon"])))),
  recordItemIOTM($item(_templateObject235 || (_templateObject235 = _taggedTemplateLiteral2(["Beach Comb Box"]))), $item(_templateObject236 || (_templateObject236 = _taggedTemplateLiteral2(["Beach Comb"])))),
  recordPreferenceIOTM($item(_templateObject237 || (_templateObject237 = _taggedTemplateLiteral2(["Distant Woods Getaway Brochure"]))), "getawayCampsiteUnlocked"),
  recordFamiliarIOTM($familiar(_templateObject238 || (_templateObject238 = _taggedTemplateLiteral2(["Pocket Professor"])))),
  recordItemIOTM($item(_templateObject239 || (_templateObject239 = _taggedTemplateLiteral2(["Unopened Eight Days a Week Pill Keeper"]))), $item(_templateObject240 || (_templateObject240 = _taggedTemplateLiteral2(["Eight Days a Week Pill Keeper"])))),
  recordWorkshedIOTM($item(_templateObject241 || (_templateObject241 = _taggedTemplateLiteral2(["unopened diabolic pizza cube box"]))), $item(_templateObject2422 || (_templateObject2422 = _taggedTemplateLiteral2(["diabolic pizza cube"])))),
  recordFamiliarIOTM($familiar(_templateObject243 || (_templateObject243 = _taggedTemplateLiteral2(["Red-Nosed Snapper"])))),
  recordItemIOTM($item(_templateObject244 || (_templateObject244 = _taggedTemplateLiteral2(["unopened Bird-a-Day calendar"]))), $item(_templateObject245 || (_templateObject245 = _taggedTemplateLiteral2(["Bird-a-Day calendar"])))),
  recordItemIOTM($item(_templateObject246 || (_templateObject246 = _taggedTemplateLiteral2(["mint-in-box Powerful Glove"]))), $item(_templateObject247 || (_templateObject247 = _taggedTemplateLiteral2(["Powerful Glove"])))),
  recordGardenIOTM($item(_templateObject248 || (_templateObject248 = _taggedTemplateLiteral2(["Better Shrooms and Gardens catalog"]))), $item(_templateObject249 || (_templateObject249 = _taggedTemplateLiteral2(["packet of mushroom spores"])))),
  recordFamiliarIOTM($familiar(_templateObject250 || (_templateObject250 = _taggedTemplateLiteral2(["Left-Hand Man"])))),
  recordItemIOTM($item(_templateObject251 || (_templateObject251 = _taggedTemplateLiteral2(["Guzzlr application"]))), $item(_templateObject2522 || (_templateObject2522 = _taggedTemplateLiteral2(["Guzzlr tablet"])))),
  recordItemIOTM($item(_templateObject253 || (_templateObject253 = _taggedTemplateLiteral2(["bag of Iunion stones"]))), $item(_templateObject254 || (_templateObject254 = _taggedTemplateLiteral2(["Iunion Crown"])))),
  recordFamiliarIOTM($familiar(_templateObject255 || (_templateObject255 = _taggedTemplateLiteral2(["Melodramedary"])))),
  recordItemIOTM($item(_templateObject256 || (_templateObject256 = _taggedTemplateLiteral2(["packaged SpinMaster\u2122 lathe"]))), $item(_templateObject257 || (_templateObject257 = _taggedTemplateLiteral2(["SpinMaster\u2122 lathe"])))),
  recordItemIOTM($item(_templateObject258 || (_templateObject258 = _taggedTemplateLiteral2(["Bagged Cargo Cultist Shorts"]))), $item(_templateObject259 || (_templateObject259 = _taggedTemplateLiteral2(["Cargo Cultist Shorts"])))),
  recordSkillIOTM($skill(_templateObject260 || (_templateObject260 = _taggedTemplateLiteral2(["Comprehensive Cartography"]))), $item(_templateObject261 || (_templateObject261 = _taggedTemplateLiteral2(["Comprehensive Cartographic Compendium"])))),
  recordItemIOTM($item(_templateObject2622 || (_templateObject2622 = _taggedTemplateLiteral2(["packaged knock-off retro superhero cape"]))), $item(_templateObject263 || (_templateObject263 = _taggedTemplateLiteral2(["unwrapped knock-off retro superhero cape"])))),
  {
    storeItem: $item(_templateObject264 || (_templateObject264 = _taggedTemplateLiteral2(["box o' ghosts"]))),
    have: have($familiar(_templateObject265 || (_templateObject265 = _taggedTemplateLiteral2(["Ghost of Crimbo Commerce"])))) || have($familiar(_templateObject266 || (_templateObject266 = _taggedTemplateLiteral2(["Ghost of Crimbo Carols"])))) || have($familiar(_templateObject267 || (_templateObject267 = _taggedTemplateLiteral2(["Ghost of Crimbo Cheer"])))),
    count: (0, import_kolmafia4.availableAmount)($item(_templateObject268 || (_templateObject268 = _taggedTemplateLiteral2(["box o' ghosts"]))))
  },
  recordItemIOTM($item(_templateObject269 || (_templateObject269 = _taggedTemplateLiteral2(["packaged miniature crystal ball"]))), $item(_templateObject270 || (_templateObject270 = _taggedTemplateLiteral2(["miniature crystal ball"])))),
  recordSkillIOTM($skill(_templateObject271 || (_templateObject271 = _taggedTemplateLiteral2(["Emotionally Chipped"]))), $item(_templateObject2722 || (_templateObject2722 = _taggedTemplateLiteral2(["emotion chip"])))),
  recordItemIOTM($item(_templateObject273 || (_templateObject273 = _taggedTemplateLiteral2(["power seed"]))), $item(_templateObject274 || (_templateObject274 = _taggedTemplateLiteral2(["potted power plant"])))),
  recordItemIOTM($item(_templateObject275 || (_templateObject275 = _taggedTemplateLiteral2(["packaged backup camera"]))), $item(_templateObject276 || (_templateObject276 = _taggedTemplateLiteral2(["backup camera"])))),
  recordFamiliarIOTM($familiar(_templateObject277 || (_templateObject277 = _taggedTemplateLiteral2(["Shorter-Order Cook"])))),
  recordItemIOTM($item(_templateObject278 || (_templateObject278 = _taggedTemplateLiteral2(["packaged familiar scrapbook"]))), $item(_templateObject279 || (_templateObject279 = _taggedTemplateLiteral2(["familiar scrapbook"])))),
  recordVIPIOTM($item(_templateObject280 || (_templateObject280 = _taggedTemplateLiteral2(["clan underground fireworks shop"])))),
  recordEudoraIOTM($item(_templateObject281 || (_templateObject281 = _taggedTemplateLiteral2(["Our Daily Candles\u2122 order form"])))),
  recordItemIOTM($item(_templateObject2822 || (_templateObject2822 = _taggedTemplateLiteral2(["packaged industrial fire extinguisher"]))), $item(_templateObject283 || (_templateObject283 = _taggedTemplateLiteral2(["industrial fire extinguisher"])))),
  recordFamiliarIOTM($familiar(_templateObject284 || (_templateObject284 = _taggedTemplateLiteral2(["Vampire Vintner"])))),
  recordItemIOTM($item(_templateObject285 || (_templateObject285 = _taggedTemplateLiteral2(["packaged Daylight Shavings Helmet"]))), $item(_templateObject286 || (_templateObject286 = _taggedTemplateLiteral2(["Daylight Shavings Helmet"])))),
  recordWorkshedIOTM($item(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral2(["packaged cold medicine cabinet"]))), $item(_templateObject288 || (_templateObject288 = _taggedTemplateLiteral2(["cold medicine cabinet"])))),
  recordPreferenceIOTM($item(_templateObject289 || (_templateObject289 = _taggedTemplateLiteral2(["undrilled cosmic bowling ball"]))), "hasCosmicBowlingBall"),
  recordItemIOTM($item(_templateObject290 || (_templateObject290 = _taggedTemplateLiteral2(["combat lover's locket lockbox"]))), $item(_templateObject291 || (_templateObject291 = _taggedTemplateLiteral2(["combat lover's locket"])))),
  recordFamiliarIOTM($familiar(_templateObject2922 || (_templateObject2922 = _taggedTemplateLiteral2(["Grey Goose"])))),
  recordItemIOTM($item(_templateObject293 || (_templateObject293 = _taggedTemplateLiteral2(["undamaged Unbreakable Umbrella"]))), $item(_templateObject294 || (_templateObject294 = _taggedTemplateLiteral2(["Unbreakable Umbrella"])))),
  recordPreferenceIOTM($item(_templateObject295 || (_templateObject295 = _taggedTemplateLiteral2(["MayDay\u2122 contract"]))), "hasMaydayContract"),
  recordItemIOTM($item(_templateObject296 || (_templateObject296 = _taggedTemplateLiteral2(["packaged June cleaver"]))), $item(_templateObject297 || (_templateObject297 = _taggedTemplateLiteral2(["June cleaver"])))),
  recordItemIOTM($item(_templateObject298 || (_templateObject298 = _taggedTemplateLiteral2(["designer sweatpants (new old stock)"]))), $item(_templateObject299 || (_templateObject299 = _taggedTemplateLiteral2(["designer sweatpants"])))),
  recordItemIOTM($item(_templateObject300 || (_templateObject300 = _taggedTemplateLiteral2(["unopened tiny stillsuit"]))), $item(_templateObject301 || (_templateObject301 = _taggedTemplateLiteral2(["tiny stillsuit"]))))
];
var MrStoreMonthly = {};
for (_i = 0, _iotmList = iotmList; _i < _iotmList.length; _i++) {
  iotm = _iotmList[_i];
  iotmID = String(Number(iotm.storeItem));
...
function haveItem(item) {
  return have(item) || (0, import_kolmafia5.displayAmount)(item) > 0;
}
function checkIotms() {
  var _loadIotms$data, _loadIotms;
  function getIOTMStatus(iotmID) {
    if (MrStoreMonthly[iotmID].have)
      return IotmStatus.BOUND;
    if (MrStoreMonthly[iotmID].count > 0)
  ...
  return ((_loadIotms$data = (_loadIotms = loadIotms()) === null || _loadIotms === void 0 ? void 0 : _loadIotms.data) !== null && _loadIotms$data !== void 0 ? _loadIotms$data : []).map(function(iotm) {
    return [iotm.id, getIOTMStatus(String(iotm.id))];
  });
}
function checkSkills() {
  var permedSkills = (0, import_kolmafia5.getPermedSkills)();
  ...
  function getLevel(skill) {
    return property_exports.getNumber("skillLevel".concat((0, import_kolmafia5.toInt)(skill)));
  }
  return import_kolmafia5.Skill.all().filter(function(skill) {
    return isPermable((0, import_kolmafia5.toInt)(skill));
  }).map(function(skill) {
    return [(0, import_kolmafia5.toInt)(skill), getStatus(skill), getLevel(skill)];
  });
}
function getHundredPercentFamiliars() {
  var history = (0, import_kolmafia5.visitUrl)("ascensionhistory.php?back=self&who=".concat((0, import_kolmafia5.myId)()), false) + (0, import_kolmafia5.visitUrl)("ascensionhistory.php?back=self&prens13=1&who=".concat((0, import_kolmafia5.myId)()), false);
  return new Set(_toConsumableArray(history.matchAll(/alt="([^"]*?) \(100%\)/gm)).map(function(m) {
    return (0, import_kolmafia5.toFamiliar)(m[1]);
  }));
}
function checkFamiliars() {
  ...
  return import_kolmafia5.Familiar.all().map(function(familiar) {
    return [(0, import_kolmafia5.toInt)(familiar), getStatus(familiar), getHundredPercent(familiar)];
  });
}
function checkTrophies() {
  var _loadTrophies$data, _loadTrophies;
  var page = (0, import_kolmafia5.visitUrl)("trophies.php");
...
function haveOutfitPieces(outfit) {
  return (0, import_kolmafia5.outfitPieces)(outfit).every(function(piece) {
    return have(piece);
  });
}
...
function checkPaths(tattoos) {
  ...
  return ((_loadPaths$data = (_loadPaths = loadPaths()) === null || _loadPaths === void 0 ? void 0 : _loadPaths.data) !== null && _loadPaths$data !== void 0 ? _loadPaths$data : []).map(function(path) {
    ...
    var items = path.items.map(function(i) {
      return haveItem(import_kolmafia5.Item.get(i)) ? ItemStatus.HAVE : ItemStatus.NONE;
    });
...
function main() {
  var tattoos = (0, import_kolmafia5.visitUrl)("account_tattoos.php");
  ...
  (0, import_kolmafia5.printHtml)('All done! To see your greenboxes, visit: <a href="https://greenbox.loathers.net/?d='.concat(code, '">https://greenbox.loathers.net/?d=').concat(code, "</a>"));
}
