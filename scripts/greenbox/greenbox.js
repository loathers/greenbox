...
var require_is_callable = __commonJS({
  "../../node_modules/core-js/internals/is-callable.js": function(exports2, module2) {
    ...
    var documentAll = (typeof document > "u" ? "undefined" : _typeof5(document)) == "object" && document.all;
...
var require_global_this = __commonJS({
  "../../node_modules/core-js/internals/global-this.js": function(exports2, module2) {
    ...
    check((typeof globalThis > "u" ? "undefined" : _typeof5(globalThis)) == "object" && globalThis) || check((typeof window > "u" ? "undefined" : _typeof5(window)) == "object" && window) || // eslint-disable-next-line no-restricted-globals -- safe
    check((typeof self > "u" ? "undefined" : _typeof5(self)) == "object" && self) || check((typeof global > "u" ? "undefined" : _typeof5(global)) == "object" && global) || check(_typeof5(exports2) == "object" && exports2) || // eslint-disable-next-line no-new-func -- fallback
    /* @__PURE__ */ (function() {
      return this;
...
var require_is_object = __commonJS({
  "../../node_modules/core-js/internals/is-object.js": function(exports2, module2) {
    ...
    module2.exports = function(it) {
      return _typeof5(it) == "object" ? it !== null : isCallable(it);
    };
  }
});
...
var require_use_symbol_as_uid = __commonJS({
  "../../node_modules/core-js/internals/use-symbol-as-uid.js": function(exports2, module2) {
    ...
    module2.exports = NATIVE_SYMBOL && !Symbol.sham && _typeof5(Symbol.iterator) == "symbol";
  }
});
...
var require_shared = __commonJS({
  "../../node_modules/core-js/internals/shared.js": function(exports2, module2) {
    "use strict";
    init_kolmafia_polyfill();
    var store = require_shared_store(), create = Object.create || Object;
    module2.exports = function(key, value) {
    ...
    module2.exports = function(options, source) {
      ...
      if (GLOBAL ? target = globalThis2 : STATIC ? target = globalThis2[TARGET] || defineGlobalProperty(TARGET, {}) : target = globalThis2[TARGET] && globalThis2[TARGET].prototype, target) for (key in source) {
        if (sourceProperty = source[key], options.dontCallGetSet ? (descriptor = getOwnPropertyDescriptor(target, key), targetProperty = descriptor && descriptor.value) : targetProperty = target[key], FORCED = isForced(GLOBAL ? key : TARGET + (STATIC ? "." : "#") + key, options.forced), !FORCED && targetProperty !== void 0) {
          if (_typeof5(sourceProperty) == _typeof5(targetProperty)) continue;
  ...
  "../../node_modules/core-js/modules/web.atob.js": function() {
    ...
    $({
      ...
      atob: function(data) {
        ...
        var string = replace(toString(data), whitespaces, ""), position = 0, bc = 0, length, chr, bs;
        string.length & 3 || (string = replace(string, finalEq, "")), length = string.length;
        var lenmod = length & 3;
        if (lenmod === 1 || exec(disallowed, string))
          throw new (getBuiltIn("DOMException"))("The string is not correctly encoded", "InvalidCharacterError");
        for (var output = new $Array((length >> 2) * 3 + (lenmod ? lenmod - 1 : 0)), outputIndex = 0; position < length; )
          chr = charAt(string, position++), bs = bc & 3 ? (bs << 6) + c2i[chr] : c2i[chr], bc++ & 3 && (output[outputIndex++] = fromCharCode(255 & bs >> (-2 * bc & 6)));
        return join(output, "");
      }
    });
  }
...
var Kmail = /* @__PURE__ */ (function() {
  function Kmail2(rawKmail) {
    _classCallCheck3(this, Kmail2), _defineProperty2(this, "id", void 0), _defineProperty2(this, "date", void 0), _defineProperty2(this, "type", void 0), _defineProperty2(this, "senderId", void 0), _defineProperty2(this, "senderName", void 0), _defineProperty2(this, "rawMessage", void 0), _defineProperty2(this, "_parsedMessageParts", void 0), this.id = Number(rawKmail.id), this.date = new Date(Number(rawKmail.azunixtime) * 1e3), this.type = rawKmail.type, this.senderId = Number(rawKmail.fromid), this.senderName = rawKmail.fromname, this.rawMessage = rawKmail.message;
  }
...
function haveBound(bindable, options) {
  ...
  switch (bindable.type) {
    ...
    case "custom":
      return bindable.id === 5790 ? haveItem(boxed) || haveItem(import_kolmafia7.Item.get("right bear arm")) && haveItem(import_kolmafia7.Item.get("left bear arm")) : !1;
    case "eudora":
...
function main() {
  ...
  var tattoos2 = (0, import_kolmafia8.visitUrl)("account_tattoos.php"), code = compress(_objectSpread2(_objectSpread2({
    meta: checkMeta(),
    skills: checkSkills(),
